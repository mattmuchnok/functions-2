...
// CODE HERE
const last = (arr, callback) => callback(arr.slice(-1))
...
// CODE HERE 
const getUserById = (arr, user, callback) => {
  for (let i = 0; i < arr.length; i++) {
    if (arr[i].id === user) {
      callback(arr[i])
    }
...
// CODE HERE
const addSixtySeven = addingFactory(67)
console.log(addSixtySeven(3))